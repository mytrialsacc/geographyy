...
const sources = [
  ...
  { title: 'USGS — Map projection tradeoffs', url: 'https://www.usgs.gov/faqs/how-are-different-map-projections-used' },
...
<section class="step"><div class="head"><span class="num">01</span><h2>Pehle yeh paanch cheezein samajh lo</h2></div><div class="cards"><article class="card"><p class="meta">Yeh website</p><h2>Tumhari step-by-step guide</h2><p>Script, prompts, file names, timings aur upload text yahan milta hai.</p></article><article class="card"><p class="meta">F5-TTS</p><h2>English script ki awaaz</h2><p>Site se sirf English script copy karke F5-TTS mein paste karni hai.</p><a href="https://f5tts-prod.duckdns.org/web/" target="_blank" rel="noopener">F5-TTS check / kholo</a></article><article class="card"><p class="meta">Google Flow</p><h2>Video ke chotay clips</h2><p>Har English prompt se 8-second video clip banta hai.</p><a href="https://labs.google/fx/tools/flow" target="_blank" rel="noopener">Google Flow check / kholo</a></article><article class="card"><p class="meta">CapCut</p><h2>Awaaz aur clips ko jorna</h2><p>Voice pehle lagti hai, Flow clips mute karke diye waqt par lagte hain.</p></article><article class="card"><p class="meta">TikTok upload pack</p><h2>Post ka tayyar text</h2><p>Caption, hashtags, cover text aur filename yahan se copy hota hai.</p></article></div><article class="clip-card"><h2>Exact voice setting</h2><ul class="instructions"><li><b>Voice:</b> bm_mix_adam_lewis</li><li><b>Speed:</b> 0.8</li><li>Har Long aur har Short mein yehi voice aur speed rakho.</li></ul></article></section>
...
<section class="step"><div class="head"><span class="num">04</span><h2>Long video ka poora order</h2></div><ol class="instructions"><li><a class="open" href="calendar.html">Calendar kholo</a> aur jis week par kaam karna hai woh dekho.</li><li><a class="open" href="longs/index.html">Lambi videos kholo</a> aur us week ka Long studio kholo.</li><li><b>01 Voiceover:</b> “Poora script copy karo” button par click ya tap karo. <a class="open" href="https://f5tts-prod.duckdns.org/web/" target="_blank" rel="noopener">F5-TTS kholo</a>, script paste karo, voice <b>bm_mix_adam_lewis</b> aur speed <b>0.8</b> select karke audio banao. Download ko page par diya exact naam do.</li><li>Wapas studio page par aao. <b>02 Voice upload</b> mein wahi MP3 select karo. Neeche ke clip timings asli voice ke mutabiq update ho jayenge.</li><li><b>03 Google Flow:</b> <a class="open" href="https://labs.google/fx/tools/flow" target="_blank" rel="noopener">Google Flow kholo</a>. New project mein model <b>Video → Veo 3.1 Lite</b>, ratio <b>16:9</b>, duration <b>8 seconds</b>, output <b>1</b>.</li><li>Clip 01 ka prompt copy karke Flow mein paste aur Generate. Sahi result download karke card par diya exact filename rakho. Isi tarah clip 40 tak.</li><li>Map/coastline ghalat, extra text, logo, broken object ya ajeeb movement ho to woh clip accept mat karo; dobara Generate.</li><li><b>04 CapCut:</b> naya 16:9 project. Voice Audio Track 1 par zero se. Saare Flow clips filename order mein import aur har clip ka <b>Volume 0</b>.</li><li>Page par updated timestamp aur quoted voice line ko dekh kar clip badlo. Gap aaye to halka slow ya clean freeze frame; black screen nahi.</li><li>Export <b>1080p, 30fps</b> aur Long/Final folder mein save.</li></ol><article class="clip-card"><p><b>Yaad:</b> voice upload karne ka matlab website par awaaz bhejna nahi. Browser file ki duration parhta hai aur sirf tumhare phone par timings update karta hai.</p></article></section>
<section class="step"><div class="head"><span class="num">05</span><h2>Teen Shorts ka poora order</h2></div><ol class="instructions"><li><a class="open" href="shorts/index.html">Choti videos kholo</a> aur Week 01 ka Short 01 kholo.</li><li>Script copy karke <a class="open" href="https://f5tts-prod.duckdns.org/web/" target="_blank" rel="noopener">F5-TTS</a> mein <b>bm_mix_adam_lewis</b>, speed <b>0.8</b> se voice banao. Page ka exact MP3 filename rakho.</li><li>Voice Short page par upload karo taake timing update ho.</li><li><a class="open" href="https://labs.google/fx/tools/flow" target="_blank" rel="noopener">Google Flow</a> mein model Veo 3.1 Lite, ratio <b>9:16</b>, duration 8 seconds aur output 1.</li><li>Har prompt alag Generate karo. Card ka exact filename rakho aur QC note se clip check karo.</li><li>CapCut 9:16 project mein voice zero se. Flow clips ka Volume 0 aur page ke updated timings/cut cues par clips badlo.</li><li>Export 1080p, 30fps aur Short 01 folder mein save.</li><li>Bilkul isi order se Short 02 aur Short 03 banao.</li></ol><p class="tip">Ek week tab production-complete hai jab 1 Long aur 3 Shorts export ho chuki hon.</p></section>
<section class="step"><div class="head"><span class="num">06</span><h2>Music aur captions</h2></div><ol class="instructions"><li>Voice sab se clear rehni chahiye.</li><li>Anas approved music de to CapCut mein <b>5%</b> volume se shuru karo; voice dab rahi ho to aur kam.</li><li>Random copyrighted song mat lagao.</li><li>English auto captions banao, har spelling check karo aur captions ko center safe area mein rakho.</li><li>TikTok buttons ke neeche ya YouTube edge ke paas text mat rakho.</li></ol></section>
...
<section class="step"><div class="head"><span class="num">10</span><h2>Agar samajh na aaye</h2></div><article class="clip-card"><p>Agar kisi step mein confusion ho to andaza na lagao. Jis screen par ruk gayi ho us ka poora screenshot Anas ko bhejo aur sirf yeh likho: <b>“Main Week 01 Long ke step 03, clip 12 par ruk gayi hoon.”</b> Is se Anas ko foran pata chal jayega ke kis jagah help chahiye.</p></article><a class="link" href="calendar.html">Ab Week ka kaam shuru karo</a></section></main>`;
